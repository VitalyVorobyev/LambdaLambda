...
Event::Event(double cth, double cth1, double sphi1, double cth2, double sphi2) :
    ...
    c_sinth1(sqrt(1. - cth1*cth1)), c_sinth2(sqrt(1. - cth2*cth2)),
    c_cosphi1(sqrt(1. - sphi1*sphi1)), c_cosphi2(sqrt(1. - sphi2*sphi2)),
    c_costhsq(cth*cth), c_sinthsq(1. - c_costhsq), c_sinth(sqrt(c_sinthsq)),
    c_sincosth(c_sinth * cth),
    c_f {
        1.,  // f0
